...
module top ;
	...
	cy_clock_v1_0
		#(.id("fa0afbf7-26fa-4f1e-b17b-763535da6f42"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("303030303030.303"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_1
		 (.clock_out(Net_164));
	...
	cy_clock_v1_0
		#(.id("c736c969-227a-41e0-a062-6e1cd5f90547"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("322580645161.29"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_2
		 (.clock_out(Net_166));
	...
	wire [0:0] tmpOE__AlarmPin_net;
	wire [0:0] tmpFB_0__AlarmPin_net;
	wire [0:0] tmpIO_0__AlarmPin_net;
	wire [0:0] tmpINTERRUPT_0__AlarmPin_net;
	electrical [0:0] tmpSIOVREF__AlarmPin_net;
	...
	cy_psoc3_pins_v1_10
		...
		AlarmPin
		 (.oe(tmpOE__AlarmPin_net),
		  .y({Net_187}),
		  .fb({tmpFB_0__AlarmPin_net[0:0]}),
		  .io({tmpIO_0__AlarmPin_net[0:0]}),
		  .siovref(tmpSIOVREF__AlarmPin_net),
		  .interrupt({tmpINTERRUPT_0__AlarmPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AlarmPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_187 = Net_199 & Net_186;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_164 or Net_166 or Net_136)
        begin
            case (Net_136)
                1'b0 :  tmp__mux_1_reg = Net_164;
                1'b1 :  tmp__mux_1_reg = Net_166;
            endcase
        end
        assign Net_199 = tmp__mux_1_reg;
    end
    // -- Mux end --

    CyControlReg_v1_80 Alarm (
        .clock(1'b0),
        .control_0(Net_186),
        .control_1(Net_189),
        .control_2(Net_190),
        ...
        .control_7(Net_196),
        .reset(1'b0));
    defparam Alarm.Bit0Mode = 0;
    defparam Alarm.Bit1Mode = 0;
    defparam Alarm.Bit2Mode = 0;
    defparam Alarm.Bit3Mode = 0;
    defparam Alarm.Bit4Mode = 0;
    defparam Alarm.Bit5Mode = 0;
    defparam Alarm.Bit6Mode = 0;
    defparam Alarm.Bit7Mode = 0;
    defparam Alarm.BitValue = 0;
    defparam Alarm.BusDisplay = 0;
    defparam Alarm.ExtrReset = 0;
    defparam Alarm.NumOutputs = 1;
