 ...
 * USBUART_5V_OPERATION_GetDTERate(), USBUART_5V_OPERATION_GetCharFormat(),
 * USBUART_5V_OPERATION_GetParityType(), and USBUART_5V_OPERATION_GetDataBits() APIs.
...
volatile uint8 USBUART_5V_OPERATION_linesCoding[USBUART_5V_OPERATION_MAX_MULTI_COM_NUM][USBUART_5V_OPERATION_LINE_CODING_SIZE] =
{
    /*COM Port 1*/
    {
...
/**Used as a flag for the USBUART_5V_OPERATION_IsLineChanged() API, to inform it that the
 ...
 * support. In case of 1 COM port, data is in 0 element.*/
volatile uint8  USBUART_5V_OPERATION_linesChanged[USBUART_5V_OPERATION_MAX_MULTI_COM_NUM];
 ...
 * USBUART_5V_OPERATION_GetLineControl() API. It is an array of 2 elements for COM 
 * port 1 and COM port 2 for MultiCOM port support. In case of 1 COM port, data 
 * is in 0 element.*/
volatile uint16 USBUART_5V_OPERATION_linesControlBitmap[USBUART_5V_OPERATION_MAX_MULTI_COM_NUM];
/** Contains the 16-bit serial state value that was sent using the 
 * \ref USBUART_5V_OPERATION_SendSerialState() API. . It is an array of 2 elements 
 * for COM port 1 and COM port 2 for MultiCOM port support. In case of 1 COM 
 * port, data is in 0 element.*/
volatile uint16 USBUART_5V_OPERATION_serialStateBitmap[USBUART_5V_OPERATION_MAX_MULTI_COM_NUM];
...
volatile uint8  USBUART_5V_OPERATION_cdcDataInEp[USBUART_5V_OPERATION_MAX_MULTI_COM_NUM];
 ...
 * port 2 for MultiCOM port support. In case of 1 COM port, data is in 0 element.*/
volatile uint8  USBUART_5V_OPERATION_cdcDataOutEp[USBUART_5V_OPERATION_MAX_MULTI_COM_NUM];
...
volatile uint8  USBUART_5V_OPERATION_cdcCommInInterruptEp[USBUART_5V_OPERATION_MAX_MULTI_COM_NUM];

/*PRIVATE*/

#define USBUART_5V_OPERATION_CDC_IN_EP      (0u)
#define USBUART_5V_OPERATION_CDC_OUT_EP     (1u)
#define USBUART_5V_OPERATION_CDC_NOTE_EP    (2u)

#define USBUART_5V_OPERATION_CDC_EP_MASK    (0x01u)

#define USBUART_5V_OPERATION_GET_EP_COM_NUM(cdcComNums, epType) (((cdcComNums) >> (epType)) & USBUART_5V_OPERATION_CDC_EP_MASK)
...
***************************************/
    ...
    static uint16 USBUART_5V_OPERATION_StrLen(const char8 string[]) ;
    static t_USBUART_5V_OPERATION_cdc_notification USBUART_5V_OPERATION_serialStateNotification =
    {

        USBUART_5V_OPERATION_SERIAL_STATE_REQUEST_TYPE, /* bRequestType    */
        USBUART_5V_OPERATION_SERIAL_STATE,              /* bNotification   */
        0u,                                         /* wValue          */
        0u,                                         /* wValueMSB       */
        0u,                                         /* wIndex          */
        0u,                                         /* wIndexMSB       */
        USBUART_5V_OPERATION_SERIAL_STATE_LENGTH,       /* wLength         */
        0u,                                         /* wLengthMSB      */
        0u,                                         /* wSerialState    */
        0u,                                         /* wSerialStateMSB */
    };
    static uint8 USBUART_5V_OPERATION_activeCom = 0u;
#endif /* (USBUART_5V_OPERATION_ENABLE_CDC_CLASS_API != 0u) */
...
/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_DispatchCDCClassRqst
****************************************************************************//**
*
...
*
* \globalvars
*   USBUART_5V_OPERATION_linesCoding: Contains the current line coding structure.
...
*   USBUART_5V_OPERATION_linesControlBitmap: Contains the current control signal
*     bitmap. It is set by the Host using SET_CONTROL_LINE request and returned
*     to the user code by the USBFS_GetLineControl() API.
*   USBUART_5V_OPERATION_linesChanged: This variable is used as a flag for the
...
uint8 USBUART_5V_OPERATION_DispatchCDCClassRqst(void) 
{
    ...
    comPort = USBUART_5V_OPERATION_GetInterfaceComPort((uint8)USBUART_5V_OPERATION_wIndexLoReg);
    ...
    if (0u != (USBUART_5V_OPERATION_bmRequestTypeReg & USBUART_5V_OPERATION_RQST_DIR_D2H))
    {
        ...
        {
            case USBUART_5V_OPERATION_CDC_GET_LINE_CODING:
                USBUART_5V_OPERATION_currentTD.count = USBUART_5V_OPERATION_LINE_CODING_SIZE;
                USBUART_5V_OPERATION_currentTD.pData = USBUART_5V_OPERATION_linesCoding[comPort];
            ...
            #ifdef USBUART_5V_OPERATION_DISPATCH_CDC_CLASS_CDC_READ_REQUESTS_CALLBACK
                requestHandled = USBUART_5V_OPERATION_DispatchCDCClass_CDC_READ_REQUESTS_Callback();
            #endif /* (USBUART_5V_OPERATION_DISPATCH_CDC_CLASS_CDC_READ_REQUESTS_CALLBACK) */
                break;
        }
    }
    else
    {
        ...
        switch (USBUART_5V_OPERATION_bRequestReg)
        {
            case USBUART_5V_OPERATION_CDC_SET_LINE_CODING:
                USBUART_5V_OPERATION_currentTD.count  = USBUART_5V_OPERATION_LINE_CODING_SIZE;
                USBUART_5V_OPERATION_currentTD.pData  = USBUART_5V_OPERATION_linesCoding[comPort];
                USBUART_5V_OPERATION_linesChanged[comPort] |= USBUART_5V_OPERATION_LINE_CODING_CHANGED;

                requestHandled = USBUART_5V_OPERATION_InitControlWrite();
                break;

            case USBUART_5V_OPERATION_CDC_SET_CONTROL_LINE_STATE:
                USBUART_5V_OPERATION_linesControlBitmap[comPort] = (uint8) USBUART_5V_OPERATION_wValueLoReg;
                USBUART_5V_OPERATION_linesChanged[comPort]      |= USBUART_5V_OPERATION_LINE_CONTROL_CHANGED;
            ...
            default:
                /* Do not handle this request unless callback is defined. */
            #ifdef USBUART_5V_OPERATION_DISPATCH_CDC_CLASS_CDC_WRITE_REQUESTS_CALLBACK
                requestHandled = USBUART_5V_OPERATION_DispatchCDCClass_CDC_WRITE_REQUESTS_Callback();
            #endif /* (USBUART_5V_OPERATION_DISPATCH_CDC_CLASS_CDC_WRITE_REQUESTS_CALLBACK) */
                break;
        }
    }
...
/***************************************************************************
* Function Name: USBUART_5V_OPERATION_GetInterfaceComPort
************************************************************************//**
*   \internal
...
uint8 USBUART_5V_OPERATION_GetInterfaceComPort(uint8 interface) 
{
    ...
    while (comPort < USBUART_5V_OPERATION_MAX_MULTI_COM_NUM)
    {
        notEp = USBUART_5V_OPERATION_cdcCommInInterruptEp[comPort];

        if (USBUART_5V_OPERATION_EP[notEp].interface == interface)
        {
            res = comPort;
            comPort = USBUART_5V_OPERATION_MAX_MULTI_COM_NUM;
        }
...
#if (USBUART_5V_OPERATION_ENABLE_CDC_CLASS_API != 0u)
/***************************************************************************
* Function Name: USBUART_5V_OPERATION_CDC_Init
************************************************************************//**
*
...
*   USBUART_5V_OPERATION_SUCCESS   CDC interface was initialized correctly
*   USBUART_5V_OPERATION_FAILURE   CDC interface was not initialized
*
* \globalvars
*   USBUART_5V_OPERATION_linesChanged: Initialized to zero.
*   USBUART_5V_OPERATION_cdcDataOutEp: Used as an OUT endpoint number.
*
* \reentrant
*  No.
*
...
uint8 USBUART_5V_OPERATION_CDC_Init(void) 
{
    uint8 comPort;
    uint8 outEp;
    uint8 ret = USBUART_5V_OPERATION_SUCCESS;

    USBUART_5V_OPERATION_activeCom = 0u;
    USBUART_5V_OPERATION_linesChanged[USBUART_5V_OPERATION_COM_PORT1] = 0u;
    USBUART_5V_OPERATION_linesChanged[USBUART_5V_OPERATION_COM_PORT2] = 0u;

    for(comPort = 0u; comPort<USBUART_5V_OPERATION_MAX_MULTI_COM_NUM; comPort++)
    {
        outEp = USBUART_5V_OPERATION_cdcDataOutEp[comPort];
        if((0u != outEp) && (USBUART_5V_OPERATION_MAX_EP > outEp))
        {
            USBUART_5V_OPERATION_EnableOutEP(outEp);
        }

    }

    /* COM Port 1 should be correct to proceed. */
    if ((0u == USBUART_5V_OPERATION_cdcDataInEp[USBUART_5V_OPERATION_COM_PORT1]) \
            || (0u == USBUART_5V_OPERATION_cdcDataOutEp[USBUART_5V_OPERATION_COM_PORT1]) \
            || (0u ==  USBUART_5V_OPERATION_cdcCommInInterruptEp[USBUART_5V_OPERATION_COM_PORT1])
            || (USBUART_5V_OPERATION_cdcDataInEp[USBUART_5V_OPERATION_COM_PORT1] >= USBUART_5V_OPERATION_MAX_EP)
            || (USBUART_5V_OPERATION_cdcDataOutEp[USBUART_5V_OPERATION_COM_PORT1] >= USBUART_5V_OPERATION_MAX_EP)
            || (USBUART_5V_OPERATION_cdcCommInInterruptEp[USBUART_5V_OPERATION_COM_PORT1] >= USBUART_5V_OPERATION_MAX_EP))
    {
        ret = USBUART_5V_OPERATION_FAILURE;
    }
...
/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_PutData
****************************************************************************//**
*
*  This function sends a specified number of bytes from the location specified
*  by a pointer to the PC. The USBUART_5V_OPERATION_CDCIsReady() function should be
...
*  identified. To send zero-length packet, use USBUART_5V_OPERATION_PutData() API
...
* \globalvars
*
*   USBUART_5V_OPERATION_cdcDataInEp: CDC IN endpoint number used for sending
*     data.
*
* \reentrant
*  No.
...
{
    uint8 epNumber = USBUART_5V_OPERATION_cdcDataInEp[USBUART_5V_OPERATION_activeCom];

    /* Limit length to maximum packet size for endpoint. */
    if (length > USBUART_5V_OPERATION_EP[epNumber].bufferSize)
    {
        /* Caution: Data will be lost if length is greater than Max Packet Size. */
        length = USBUART_5V_OPERATION_EP[epNumber].bufferSize;

        /* Halt CPU in debug mode */
        CYASSERT(0u != 0u);
    }

    USBUART_5V_OPERATION_LoadInEP(epNumber, pData, length);
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_StrLen
****************************************************************************//**
*
...
/***************************************************************************
* Function Name: USBUART_5V_OPERATION_PutString
************************************************************************//**
*
...
*  The USBUART_5V_OPERATION_CDCIsReady() function should be called before
*  sending data with a new call to USBUART_5V_OPERATION_PutString(), to be sure
...
void USBUART_5V_OPERATION_PutString(const char8 string[]) 
{
    ...
    strLength = USBUART_5V_OPERATION_StrLen(string);

    do
    {
        /* Limit length to maximum packet size of endpoint. */
        sendLength = (strLength > USBUART_5V_OPERATION_EP[epNumber].bufferSize) ?
                                  USBUART_5V_OPERATION_EP[epNumber].bufferSize : strLength;

        /* Load IN endpoint and expose it to host. */
        USBUART_5V_OPERATION_LoadInEP(epNumber, (const uint8 *)&string[bufIndex], sendLength);
        strLength -= sendLength;

        /* If more data are present to send or full packet was sent */
        if ((strLength > 0u) || (sendLength == USBUART_5V_OPERATION_EP[epNumber].bufferSize))
        {
            bufIndex += sendLength;

            /* Wait until host read data from IN endpoint buffer. */
            while (USBUART_5V_OPERATION_IN_BUFFER_FULL == USBUART_5V_OPERATION_EP[epNumber].apiEpState)
            {
            }
            ...
            */
            if (0u == strLength)
            {
                USBUART_5V_OPERATION_LoadInEP(epNumber, NULL, 0u);
            }
        }
    }
    while (strLength > 0u);
...
/***************************************************************************
* Function Name: USBUART_5V_OPERATION_PutChar
************************************************************************//**
*
...
void USBUART_5V_OPERATION_PutChar(char8 txDataByte) 
{
    ...
    USBUART_5V_OPERATION_LoadInEP(USBUART_5V_OPERATION_cdcDataInEp[USBUART_5V_OPERATION_activeCom], &dataByte, 1u);
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_PutCRLF
****************************************************************************//**
*
...
void USBUART_5V_OPERATION_PutCRLF(void) 
{
    ...
    USBUART_5V_OPERATION_LoadInEP(USBUART_5V_OPERATION_cdcDataInEp[USBUART_5V_OPERATION_activeCom], (const uint8 *)txData, 2u);
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_GetCount
****************************************************************************//**
*
*  This function returns the number of bytes that were received from the PC.
*  The returned length value should be passed to USBUART_5V_OPERATION_GetData() as
*  a parameter to read all received data. If all of the received data is not
*  read at one time by the USBUART_5V_OPERATION_GetData() API, the unread data will
*  be lost.
*
* \return
...
*
* \globalvars
*   USBUART_5V_OPERATION_cdcDataOutEp: CDC OUT endpoint number used.
*
*******************************************************************************/
uint16 USBUART_5V_OPERATION_GetCount(void) 
{
    ...
    uint8  epNumber = USBUART_5V_OPERATION_cdcDataOutEp[USBUART_5V_OPERATION_activeCom];

    if (USBUART_5V_OPERATION_OUT_BUFFER_FULL == USBUART_5V_OPERATION_EP[epNumber].apiEpState)
    {
        bytesCount = USBUART_5V_OPERATION_GetEPCount(epNumber);
    }
    else
    {
        bytesCount = 0u;
...
/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_DataIsReady
****************************************************************************//**
*
*  This function returns a non-zero value if the component received data or
*  received zero-length packet. The USBUART_5V_OPERATION_GetAll() or
*  USBUART_5V_OPERATION_GetData() API should be called to read data from the buffer
...
{
    return (USBUART_5V_OPERATION_GetEPState(USBUART_5V_OPERATION_cdcDataOutEp[USBUART_5V_OPERATION_activeCom]));
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_CDCIsReady
****************************************************************************//**
*
...
*  USBUART_5V_OPERATION_PutData(),USBUART_5V_OPERATION_PutString(),
*  USBUART_5V_OPERATION_PutChar or USBUART_5V_OPERATION_PutCRLF(),
...
*
* \globalvars
*   USBUART_5V_OPERATION_cdcDataInEp: CDC IN endpoint number used.
*
*******************************************************************************/
uint8 USBUART_5V_OPERATION_CDCIsReady(void) 
{
    return (USBUART_5V_OPERATION_GetEPState(USBUART_5V_OPERATION_cdcDataInEp[USBUART_5V_OPERATION_activeCom]));
}


/***************************************************************************
* Function Name: USBUART_5V_OPERATION_GetData
************************************************************************//**
*
...
*  The USBUART_5V_OPERATION_DataIsReady() API should be called first, to be sure
*  that data is received from the host. If all received data will not be read at
*  once, the unread data will be lost. The USBUART_5V_OPERATION_GetData() API should
...
uint16 USBUART_5V_OPERATION_GetData(uint8* pData, uint16 length) 
{
    ...
    length = USBUART_5V_OPERATION_ReadOutEP(epNumber, pData, length);

#if (USBUART_5V_OPERATION_EP_MANAGEMENT_DMA_MANUAL)
    /* Wait until DMA complete transferring data from OUT endpoint buffer. */
    while (USBUART_5V_OPERATION_OUT_BUFFER_FULL == USBUART_5V_OPERATION_GetEPState(epNumber))
    {
    }
...
*
* \globalvars
*   - \ref USBUART_5V_OPERATION_cdcDataOutEp: CDC OUT endpoint number used.
*   - \ref USBUART_5V_OPERATION_EP[].bufferSize: EP max packet size is used as a
...
uint16 USBUART_5V_OPERATION_GetAll(uint8* pData) 
{
    ...
    /* Read data from OUT endpoint buffer. */
    dataLength = USBUART_5V_OPERATION_ReadOutEP(epNumber, pData, USBUART_5V_OPERATION_EP[epNumber].bufferSize);
...
/***************************************************************************
* Function Name: USBUART_5V_OPERATION_GetChar
************************************************************************//**
*
...
uint8 USBUART_5V_OPERATION_GetChar(void) 
{
    ...
    (void) USBUART_5V_OPERATION_ReadOutEP(epNumber, &rxData, 1u);
...
/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_IsLineChanged
****************************************************************************//**
*
...
*  device. The USBUART_5V_OPERATION_GetDTERate(), USBUART_5V_OPERATION_GetCharFormat()
*  or USBUART_5V_OPERATION_GetParityType() or USBUART_5V_OPERATION_GetDataBits() API
*  should be called to read data coding information.
*  The USBUART_5V_OPERATION_GetLineControl() API should be called to read line
*  control information.
*
* \return
...
*
* \globalvars
*  - \ref USBUART_5V_OPERATION_transferState: it is checked to be sure then OUT
*    data phase has been complete, and data written to the lineCoding or
*    Control Bitmap buffer.
*  - \ref USBUART_5V_OPERATION_linesChanged: used as a flag to be aware that
...
uint8 USBUART_5V_OPERATION_IsLineChanged(void) 
{
    ...
    if (USBUART_5V_OPERATION_transferState == USBUART_5V_OPERATION_TRANS_STATE_IDLE)
    {
        if (USBUART_5V_OPERATION_linesChanged[USBUART_5V_OPERATION_activeCom] != 0u)
        {
            state = USBUART_5V_OPERATION_linesChanged[USBUART_5V_OPERATION_activeCom];
            USBUART_5V_OPERATION_linesChanged[USBUART_5V_OPERATION_activeCom] = 0u;
        }
    }
...
/***************************************************************************
* Function Name: USBUART_5V_OPERATION_GetDTERate
************************************************************************//**
*
...
*
* \globalvars
*  USBUART_5V_OPERATION_linesCoding: First four bytes converted to uint32
...
uint32 USBUART_5V_OPERATION_GetDTERate(void) 
{
    ...
    rate = USBUART_5V_OPERATION_linesCoding[USBUART_5V_OPERATION_activeCom][USBUART_5V_OPERATION_LINE_CODING_RATE + 3u];
    rate = (rate << 8u) | USBUART_5V_OPERATION_linesCoding[USBUART_5V_OPERATION_activeCom][USBUART_5V_OPERATION_LINE_CODING_RATE + 2u];
    rate = (rate << 8u) | USBUART_5V_OPERATION_linesCoding[USBUART_5V_OPERATION_activeCom][USBUART_5V_OPERATION_LINE_CODING_RATE + 1u];
    rate = (rate << 8u) | USBUART_5V_OPERATION_linesCoding[USBUART_5V_OPERATION_activeCom][USBUART_5V_OPERATION_LINE_CODING_RATE];
...
/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_GetCharFormat
****************************************************************************//**
*
...
*
* \globalvars
*  USBUART_5V_OPERATION_linesCoding: used to get a parameter.
*
*******************************************************************************/
uint8 USBUART_5V_OPERATION_GetCharFormat(void) 
{
    return (USBUART_5V_OPERATION_linesCoding[USBUART_5V_OPERATION_activeCom][USBUART_5V_OPERATION_LINE_CODING_STOP_BITS]);
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_GetParityType
****************************************************************************//**
*
...
{
    return (USBUART_5V_OPERATION_linesCoding[USBUART_5V_OPERATION_activeCom][USBUART_5V_OPERATION_LINE_CODING_PARITY]);
}


/***************************************************************************
* Function Name: USBUART_5V_OPERATION_GetDataBits
************************************************************************//**
*
...
{
    return (USBUART_5V_OPERATION_linesCoding[USBUART_5V_OPERATION_activeCom][USBUART_5V_OPERATION_LINE_CODING_DATA_BITS]);
}


/***************************************************************************
* Function Name: USBUART_5V_OPERATION_GetLineControl
************************************************************************//**
*
...
*
* \globalvars
*  USBUART_5V_OPERATION_linesControlBitmap: used to get a parameter.
*
*******************************************************************************/
uint16 USBUART_5V_OPERATION_GetLineControl(void) 
{
    return (USBUART_5V_OPERATION_linesControlBitmap[USBUART_5V_OPERATION_activeCom]);
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_SendSerialState
****************************************************************************//**
*
...
*  USBUART_5V_OPERATION_NotificationIsReady() API must be called to check if the
...
{
    uint8 epNumber = USBUART_5V_OPERATION_cdcCommInInterruptEp[USBUART_5V_OPERATION_activeCom];

    if(USBUART_5V_OPERATION_SERIAL_STATE_SIZE <= USBUART_5V_OPERATION_EP[epNumber].bufferSize)
    {
        /* Save current SERIAL_STATE bitmap. */
        USBUART_5V_OPERATION_serialStateBitmap[USBUART_5V_OPERATION_activeCom] = serialState;

        /* Add interface number */
        USBUART_5V_OPERATION_serialStateNotification.wIndex = USBUART_5V_OPERATION_EP[epNumber].interface;

        /*Form SERIAL_STATE data*/
        USBUART_5V_OPERATION_serialStateNotification.wSerialState =    LO8(USBUART_5V_OPERATION_serialStateBitmap[USBUART_5V_OPERATION_activeCom]);
        USBUART_5V_OPERATION_serialStateNotification.wSerialStateMSB = HI8(USBUART_5V_OPERATION_serialStateBitmap[USBUART_5V_OPERATION_activeCom]);

        USBUART_5V_OPERATION_LoadInEP(epNumber, (uint8 *) &USBUART_5V_OPERATION_serialStateNotification, sizeof(USBUART_5V_OPERATION_serialStateNotification));
    }
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_GetSerialState
****************************************************************************//**
*
...
{
    return USBUART_5V_OPERATION_serialStateBitmap[USBUART_5V_OPERATION_activeCom];
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_NotificationIsReady
****************************************************************************//**
*
...
*  USBUART_5V_OPERATION_SendSerialState() to ensure that any previous
...
{
    return (USBUART_5V_OPERATION_EP[USBUART_5V_OPERATION_cdcCommInInterruptEp[USBUART_5V_OPERATION_activeCom]].apiEpState);
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_SetComPort
****************************************************************************//**
*
...
{
    if ((USBUART_5V_OPERATION_activeCom != comNumber) && \
            (comNumber < USBUART_5V_OPERATION_MAX_MULTI_COM_NUM ))
    {
        USBUART_5V_OPERATION_activeCom = comNumber;
    }
}


/*******************************************************************************
* Function Name: USBUART_5V_OPERATION_GetComPort
****************************************************************************//**
*
...
{
    return (USBUART_5V_OPERATION_activeCom);
}
...
/***************************************************************************
* Function Name: USBUART_5V_OPERATION_Cdc_EpInit
************************************************************************//**
*
*  \internal
...
*   USBUART_5V_OPERATION_cdcDataInEp[], USBUART_5V_OPERATION_cdcCommInInterruptEp[],
*   USBUART_5V_OPERATION_cdcDataOutEp[]
*
...
uint8 USBUART_5V_OPERATION_Cdc_EpInit(const T_USBUART_5V_OPERATION_EP_SETTINGS_BLOCK CYCODE *pEP, uint8 epNum, uint8 cdcComNums) 
{
    ...
    {
        if (epType != USBUART_5V_OPERATION_EP_TYPE_INT)
        {
            USBUART_5V_OPERATION_cdcDataInEp[USBUART_5V_OPERATION_GET_EP_COM_NUM(cdcComNums, USBUART_5V_OPERATION_CDC_IN_EP)] = epNum;
            cdcComNums |= (uint8)(USBUART_5V_OPERATION_COM_PORT2 << USBUART_5V_OPERATION_CDC_IN_EP);
        }
        else
        {

            USBUART_5V_OPERATION_cdcCommInInterruptEp[USBUART_5V_OPERATION_GET_EP_COM_NUM(cdcComNums, USBUART_5V_OPERATION_CDC_NOTE_EP)] = epNum;
            cdcComNums |= (uint8)(USBUART_5V_OPERATION_COM_PORT2 << USBUART_5V_OPERATION_CDC_NOTE_EP);
        }
    }
    else
    {
        if (epType != USBUART_5V_OPERATION_EP_TYPE_INT)
        {
            USBUART_5V_OPERATION_cdcDataOutEp[USBUART_5V_OPERATION_GET_EP_COM_NUM(cdcComNums, USBUART_5V_OPERATION_CDC_OUT_EP)] = epNum;
            cdcComNums |= (uint8)(USBUART_5V_OPERATION_COM_PORT2 << USBUART_5V_OPERATION_CDC_OUT_EP);
        }
    }
    return (cdcComNums);
}
