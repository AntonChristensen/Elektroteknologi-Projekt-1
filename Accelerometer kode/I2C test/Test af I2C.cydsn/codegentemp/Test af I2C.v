// ======================================================================
// Test af I2C.v generated from TopDesign.cysch
// 05/03/2026 at 13:42
...
module top ;
	...
	wire [0:0] tmpOE__INTPin_net;
	wire [0:0] tmpIO_0__INTPin_net;
	wire [0:0] tmpINTERRUPT_0__INTPin_net;
	electrical [0:0] tmpSIOVREF__INTPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		INTPin
		 (.oe(tmpOE__INTPin_net),
		  .y({1'b0}),
		  .fb({Net_14}),
		  .io({tmpIO_0__INTPin_net[0:0]}),
		  .siovref(tmpSIOVREF__INTPin_net),
		  .interrupt({tmpINTERRUPT_0__INTPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INTPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
