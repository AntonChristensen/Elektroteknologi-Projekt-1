/***************************************************************************//**
* \file USBUART_5V_OPERATION_descr.c
* \version 3.20
*
* \brief
...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USBUART_5V_OPERATION_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBUART_5V_OPERATION_DEVICE0_CONFIGURATION0_DESCR[67u] = {
...
*********************************************************************/
const uint8 CYCODE USBUART_5V_OPERATION_STRING_DESCRIPTORS[159u] = {
/*********************************************************************
...
*********************************************************************/
const uint8 CYCODE USBUART_5V_OPERATION_SN_STRING_DESCRIPTOR[2] = {
...
*********************************************************************/
const T_USBUART_5V_OPERATION_EP_SETTINGS_BLOCK CYCODE USBUART_5V_OPERATION_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[3u] = {
...
const uint8 CYCODE USBUART_5V_OPERATION_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[2u] = {
0x02u, 0x0Au
};
/*********************************************************************
...
*********************************************************************/
const T_USBUART_5V_OPERATION_LUT CYCODE USBUART_5V_OPERATION_DEVICE0_CONFIGURATION0_TABLE[5u] = {
    {0x01u,     &USBUART_5V_OPERATION_DEVICE0_CONFIGURATION0_DESCR},
    {0x03u,     &USBUART_5V_OPERATION_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &USBUART_5V_OPERATION_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USBUART_5V_OPERATION_LUT CYCODE USBUART_5V_OPERATION_DEVICE0_TABLE[3u] = {
    {0x01u,     &USBUART_5V_OPERATION_DEVICE0_DESCR},
    {0x00u,    NULL},
    {0x01u,     &USBUART_5V_OPERATION_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USBUART_5V_OPERATION_LUT CYCODE USBUART_5V_OPERATION_TABLE[1u] = {
    {0x01u,     &USBUART_5V_OPERATION_DEVICE0_TABLE}
};
    ...
    *  USBUART_5V_OPERATION_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USBUART_5V_OPERATION_MSOS_DESCRIPTOR[USBUART_5V_OPERATION_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   USBUART_5V_OPERATION_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USBUART_5V_OPERATION_MSOS_CONFIGURATION_DESCR[USBUART_5V_OPERATION_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USBUART_5V_OPERATION_idSerialNumberStringDescriptor[USBUART_5V_OPERATION_IDSN_DESCR_LENGTH];
