// ======================================================================
// Accelerometer mega til psoc.v generated from TopDesign.cysch
// 05/04/2026 at 17:05
...
module top ;
	...
	wire [0:0] tmpOE__Reset_NANO_net;
	wire [0:0] tmpFB_0__Reset_NANO_net;
	wire [0:0] tmpIO_0__Reset_NANO_net;
	wire [0:0] tmpINTERRUPT_0__Reset_NANO_net;
	electrical [0:0] tmpSIOVREF__Reset_NANO_net;

	cy_psoc3_pins_v1_10
		#(.id("b96ae4d8-dbf6-4ca2-a2e0-15fe8c4fcd8b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Reset_NANO
		 (.oe(tmpOE__Reset_NANO_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Reset_NANO_net[0:0]}),
		  .io({tmpIO_0__Reset_NANO_net[0:0]}),
		  .siovref(tmpSIOVREF__Reset_NANO_net),
		  .interrupt({tmpINTERRUPT_0__Reset_NANO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Reset_NANO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
