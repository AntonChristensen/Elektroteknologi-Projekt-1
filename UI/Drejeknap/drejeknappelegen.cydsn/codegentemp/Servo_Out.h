...
void    Servo_Out_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Servo_Out_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Servo_Out__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Servo_Out_SetInterruptMode() function.
     *  @{
     */
        #define Servo_Out_INTR_NONE      (uint16)(0x0000u)
        #define Servo_Out_INTR_RISING    (uint16)(0x0001u)
        #define Servo_Out_INTR_FALLING   (uint16)(0x0002u)
        #define Servo_Out_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Servo_Out_INTR_MASK      (0x01u) 
#endif /* (Servo_Out__INTSTAT) */
...
/* SIO registers */
#if defined(Servo_Out__SIO_CFG)
    #define Servo_Out_SIO_HYST_EN        (* (reg8 *) Servo_Out__SIO_HYST_EN)
    #define Servo_Out_SIO_REG_HIFREQ     (* (reg8 *) Servo_Out__SIO_REG_HIFREQ)
    #define Servo_Out_SIO_CFG            (* (reg8 *) Servo_Out__SIO_CFG)
    #define Servo_Out_SIO_DIFF           (* (reg8 *) Servo_Out__SIO_DIFF)
#endif /* (Servo_Out__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Servo_Out_0_INTTYPE_REG 		(* (reg8 *) Servo_Out__0__INTTYPE)
#endif /* (Servo_Out__INTSTAT) */
