...
void PWM_Buzzer_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_Buzzer_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_Buzzer_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(PWM_Buzzer_CAPTURE_LSB_PTR));
    }
...
void PWM_Buzzer_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_Buzzer_PERIOD_LSB_PTR, period);
    #endif /* (PWM_Buzzer_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_Buzzer_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_Buzzer_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWM_Buzzer_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_Buzzer_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_Buzzer_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_Buzzer_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_Buzzer_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_Buzzer_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_Buzzer_COMPARE1_LSB_PTR));
        #endif /* (PWM_Buzzer_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_Buzzer_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_Buzzer_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_Buzzer_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_Buzzer_PERIOD_LSB_PTR));
    #endif /* (PWM_Buzzer_UsingFixedFunction) */
}
