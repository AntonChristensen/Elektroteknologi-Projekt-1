...
void PWM_Servo_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_Servo_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_Servo_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(PWM_Servo_CAPTURE_LSB_PTR));
    }
...
void PWM_Servo_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_Servo_PERIOD_LSB_PTR, period);
    #endif /* (PWM_Servo_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_Servo_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_Servo_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWM_Servo_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_Servo_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_Servo_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_Servo_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_Servo_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_Servo_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_Servo_COMPARE1_LSB_PTR));
        #endif /* (PWM_Servo_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_Servo_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_Servo_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_Servo_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_Servo_PERIOD_LSB_PTR));
    #endif /* (PWM_Servo_UsingFixedFunction) */
}
