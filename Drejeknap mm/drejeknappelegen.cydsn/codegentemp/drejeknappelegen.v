// ======================================================================
// drejeknappelegen.v generated from TopDesign.cysch
// 05/10/2026 at 18:20
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=9333338, ADC_Input_Range=0, ADC_Power=0, ADC_Reference=1, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=1.024, Ref_Voltage_mV=1024, rm_int=false, Sample_Precharge=6, Sample_Rate=666667, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_ServoFB, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_ServoFB, CY_INSTANCE_SHORT_NAME=ADC_ServoFB, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_ServoFB, )
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("5f54b036-a64f-4ae0-87d6-83efba1f542b/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5f54b036-a64f-4ae0-87d6-83efba1f542b/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    Debouncer_v1_0 Deb_Butt (
        ...
        .pos(Net_103),
        .q(Net_102));
    defparam Deb_Butt.EitherEdgeDetect = 1;
    defparam Deb_Butt.NegEdgeDetect = 1;
    defparam Deb_Butt.PosEdgeDetect = 1;
    defparam Deb_Butt.SignalWidth = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("3f536540-a90e-4970-94bf-2344eaeb4fa6"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    Debouncer_v1_0 Deb_Rot_A (
        ...
        .pos(Net_101),
        .q(Net_84));
    defparam Deb_Rot_A.EitherEdgeDetect = 1;
    defparam Deb_Rot_A.NegEdgeDetect = 1;
    defparam Deb_Rot_A.PosEdgeDetect = 1;
    defparam Deb_Rot_A.SignalWidth = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("bb4a0a2b-0d58-4e10-a3b5-1e6c6a22f432"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("a9395623-7793-4062-905b-c9d7e2e48bf4"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("634fffbb-0c51-4504-b49d-df26c75f24a2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Debouncer_v1_0 Deb_Rot_B (
        ...
        .pos(Net_83),
        .q(Net_89));
    defparam Deb_Rot_B.EitherEdgeDetect = 1;
    defparam Deb_Rot_B.NegEdgeDetect = 1;
    defparam Deb_Rot_B.PosEdgeDetect = 1;
    defparam Deb_Rot_B.SignalWidth = 1;

    CyStatusReg_v1_90 Status_Rot_B (
        .clock(Net_31),
        .intr(Net_98),
        .status_0(Net_89),
        .status_1(1'b0),
        ...
        .status_7(1'b0),
        .status_bus(8'b0));
    defparam Status_Rot_B.Bit0Mode = 0;
    defparam Status_Rot_B.Bit1Mode = 0;
    defparam Status_Rot_B.Bit2Mode = 0;
    defparam Status_Rot_B.Bit3Mode = 0;
    defparam Status_Rot_B.Bit4Mode = 0;
    defparam Status_Rot_B.Bit5Mode = 0;
    defparam Status_Rot_B.Bit6Mode = 0;
    defparam Status_Rot_B.Bit7Mode = 0;
    defparam Status_Rot_B.BusDisplay = 0;
    defparam Status_Rot_B.Interrupt = 0;
    defparam Status_Rot_B.MaskValue = 0;
    defparam Status_Rot_B.NumInputs = 8;
	...
	cy_psoc3_pins_v1_10
		#(.id("96e041c8-30aa-4b33-8646-866c4aad4dd8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_0 PWM_Servo (
        ...
        .tc(Net_1264),
        .trigger(1'b0));
    defparam PWM_Servo.Resolution = 8;

	wire [0:0] tmpOE__Servo_FB_net;
	wire [0:0] tmpFB_0__Servo_FB_net;
	wire [0:0] tmpIO_0__Servo_FB_net;
	wire [0:0] tmpINTERRUPT_0__Servo_FB_net;
	electrical [0:0] tmpSIOVREF__Servo_FB_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Servo_FB
		 (.oe(tmpOE__Servo_FB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Servo_FB_net[0:0]}),
		  .analog({Net_841}),
		  .io({tmpIO_0__Servo_FB_net[0:0]}),
		  .siovref(tmpSIOVREF__Servo_FB_net),
		  .interrupt({tmpINTERRUPT_0__Servo_FB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Servo_FB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_v3_10_1 ADC_ServoFB (
        .aclk(1'b0),
        .eoc(Net_844),
        .eos(Net_847),
        .soc(1'b0),
	...
	cy_clock_v1_0
		#(.id("1780e00e-925c-4e95-90f7-fd0bfffd9bfe"),
	...
	wire [0:0] tmpOE__alarm_LED_net;
	wire [0:0] tmpFB_0__alarm_LED_net;
	wire [0:0] tmpIO_0__alarm_LED_net;
	wire [0:0] tmpINTERRUPT_0__alarm_LED_net;
	electrical [0:0] tmpSIOVREF__alarm_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("6ea6ff34-b662-432a-aac1-096c425e9d9a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		alarm_LED
		 (.oe(tmpOE__alarm_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__alarm_LED_net[0:0]}),
		  .io({tmpIO_0__alarm_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__alarm_LED_net),
		  .interrupt({tmpINTERRUPT_0__alarm_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__alarm_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("8525a970-3d7a-4079-a402-8783920cbb4c"),
    ...
    Timer_v2_80_2 SysTickTimer (
        .capture(1'b0),
        .capture_out(Net_1297),
        .clock(Net_1293),
        .enable(1'b1),
        .interrupt(Net_1306),
        .reset(Net_1295),
        .tc(Net_1305),
        .trigger(1'b1));
    defparam SysTickTimer.CaptureCount = 2;
    defparam SysTickTimer.CaptureCounterEnabled = 0;
    defparam SysTickTimer.DeviceFamily = "PSoC5";
    defparam SysTickTimer.InterruptOnCapture = 0;
    defparam SysTickTimer.InterruptOnTC = 1;
    defparam SysTickTimer.Resolution = 16;
    defparam SysTickTimer.SiliconRevision = "0";
